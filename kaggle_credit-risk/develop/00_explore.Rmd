...
- I normally use a combination of str(), summary(), glimpse() to do this and recently explored skim() of which the results are shown here.
- I like how it splits the summary statistics across variable type and shows a basic histogram for numerical types. 
...
subset(data.frame(missing_val_abs, missing_val_per), missing_val_per>0) %>%
  datatable(filter = 'top', colnames = c('Total missing values', 'Percentage missing values'), 
...
Notes: There is a really large outlier at over $100 000 000 for total income. It seems unlikely that such an individual would be applying for a loan and this could be a mistake.
