...
As this is my own data, I know what these outliers are from! firstly, llok at the average pace of entries 345 and 352. This was not a run! These were actually cycles where I didn;t classigy the activities correctly. Secondly, the 65km entry on 13 August was when I used my Garmin watch to measure how far we travelled on a boat in Brazil :) So, let's remove these three entries. I've also never run anything longer than 60km - yet!
